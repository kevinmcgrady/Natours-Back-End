...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2V2aW5tY2dyYWR5NDciLCJhIjoiY2o3cnh5cXVvM3VlcTJ3cWtuam91djczdiJ9.GWEegcrqrRlCd_Qz0f_zDg';
...
exports.updateAccountDetails = void 0;
...
var submitButton = document.querySelector('.form-user-data .btn--green');
var passwordSubmitButton = document.querySelector('.form-user-settings .btn--green');
var spinner = "<div class=\"lds-ring\"><div></div><div></div><div></div><div></div></div>";

var updateAccountDetails = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            button = type === 'password' ? passwordSubmitButton : submitButton;
            _context.prev = 1;
  ...
  return function updateAccountDetails(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateDetailsForm = document.querySelector('.form.form-user-data');
...
if (updateDetailsForm) {
  updateDetailsForm.addEventListener('submit', function (e) {
    ...
    (0, _updateAccount.updateAccountDetails)(form, 'details');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _updateAccount.updateAccountDetails)({
